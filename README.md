...
[![Build Status](https://travis-ci.org/OmegaDroid/django-model-monitor.svg?branch=master)](https://travis-ci.org/OmegaDroid/django-model-monitor.svg?branch=master)
